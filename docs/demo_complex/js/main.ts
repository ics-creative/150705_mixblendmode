...
module demo.css3 {
	...
	var app:angular.IModule = angular.module('ui.bootstrap.demo', ['ui.bootstrap']);

	// ----------------------------------
	// 全体の制御
	// ----------------------------------
	app.controller("MyAppCtrl", ($scope, $log) => {
	...
	// ドロップダウンメニューの制御
	// ----------------------------------
	app.controller('DropdownCtrl', ($scope, $log) => {
